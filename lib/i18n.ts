...
const releasePricingPhraseTranslations: Partial<Record<ReviewIntelLocale, Record<string, string>>> = {
  fr: {
    ...
    "BUY / CONSIDER / AVOID verdict": "Verdict ACHETER / CONSIDÉRER / ÉVITER",
  ...
  es: {
    ...
    "BUY / CONSIDER / AVOID verdict": "Veredicto COMPRAR / CONSIDERAR / EVITAR",
  ...
  de: {
    ...
    "BUY / CONSIDER / AVOID verdict": "Urteil KAUFEN / PRÜFEN / MEIDEN",
  ...
  zh: {
    ...
    "BUY / CONSIDER / AVOID verdict": "买入 / 考虑 / 避免 判断",
  ...
  hi: {
    ...
    "BUY / CONSIDER / AVOID verdict": "BUY / CONSIDER / AVOID verdict",
