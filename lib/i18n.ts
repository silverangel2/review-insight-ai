...
const extraPhraseTranslations = {
  fr: {
    ...
    "Screenshot-worthy": "Résultat digne d’une capture",
  ...
  es: {
    ...
    "Screenshot-worthy": "Resultado digno de captura",
  ...
  de: {
    ...
    "Screenshot-worthy": "Screenshot-würdiges Ergebnis",
  ...
  hi: {
    ...
    "Screenshot-worthy": "स्क्रीनशॉट योग्य परिणाम",
...
const releasePricingPhraseTranslations: Partial<Record<ReviewIntelLocale, Record<string, string>>> = {
  fr: {
    ...
    "Start simple": "Commencer simplement",
    "Best for shoppers": "Idéal pour acheteurs",
    "Seller intelligence": "Intelligence vendeur",
    "Growth command": "Pilotage croissance",
    "For quick product checks before you buy.": "Pour vérifier rapidement un produit avant d’acheter.",
    "Trying ReviewIntel without a subscription.": "Essayer ReviewIntel sans abonnement.",
    "3 product scans per day": "3 analyses produit par jour",
    "Screenshot or product-link scan": "Analyse par capture ou lien produit",
    "BUY / REVIEW FIRST / AVOID verdict": "Verdict ACHETER / À REVOIR / ÉVITER",
    "Latest result only": "Résultat le plus récent seulement",
    "For people who compare often and want stronger buying confidence.": "Pour ceux qui comparent souvent et veulent plus de confiance avant achat.",
    "Frequent online shopping, deal checks, and product comparison.": "Achats fréquents, vérification des offres et comparaison de produits.",
    ...
    "Seller product health scan": "Analyse santé produit vendeur",
    "Complaint clustering": "Regroupement des plaintes",
    "Buyer psychology signals": "Signaux de psychologie acheteur",
    "Export-ready insights": "Insights prêts à exporter",
    "Seller dashboard history": "Historique tableau de bord vendeur",
    "For serious sellers tracking improvement over time and learning how to outgrow competitors.": "Pour les vendeurs sérieux qui suivent l’amélioration et veulent dépasser les concurrents.",
    "Product improvement tracking, competitor positioning, and growth planning.": "Suivi d’amélioration produit, positionnement concurrentiel et planification de croissance.",
    "Competitor compare intelligence": "Intelligence de comparaison concurrente",
    "Improvement calendar": "Calendrier d’amélioration",
    "Seller Pro growth graph": "Graphique de croissance Seller Pro",
    "Product score movement": "Évolution du score produit",
    "Deeper action planning": "Plan d’action approfondi",
    "Login, security, language, account mode, and privacy-friendly traffic counts use essential storage. Optional Google ad cookies load only if you accept.": "Connexion, sécurité, langue, mode de compte et comptage de trafic respectueux de la vie privée utilisent le stockage essentiel. Les cookies publicitaires Google ne se chargent que si vous acceptez."
  },
  es: {
    ...
    "Start simple": "Empieza simple",
    "Best for shoppers": "Ideal para compradores",
    "Seller intelligence": "Inteligencia vendedor",
    "Growth command": "Control de crecimiento",
    "For quick product checks before you buy.": "Para revisar productos rápido antes de comprar.",
    "Trying ReviewIntel without a subscription.": "Probar ReviewIntel sin suscripción.",
    "3 product scans per day": "3 escaneos por día",
    "Screenshot or product-link scan": "Escaneo con captura o enlace",
    "BUY / REVIEW FIRST / AVOID verdict": "Veredicto COMPRAR / REVISAR PRIMERO / EVITAR",
    "Latest result only": "Solo el resultado más reciente",
    "For people who compare often and want stronger buying confidence.": "Para quienes comparan seguido y quieren más confianza al comprar.",
    "Frequent online shopping, deal checks, and product comparison.": "Compras frecuentes, revisión de ofertas y comparación.",
    ...
    "Seller product health scan": "Salud del producto vendedor",
    "Complaint clustering": "Agrupación de quejas",
    "Buyer psychology signals": "Señales de psicología del comprador",
    "Export-ready insights": "Insights listos para exportar",
    "Seller dashboard history": "Historial del panel vendedor",
    "For serious sellers tracking improvement over time and learning how to outgrow competitors.": "Para vendedores serios que siguen mejoras y quieren superar competidores.",
    "Product improvement tracking, competitor positioning, and growth planning.": "Seguimiento de mejoras, posicionamiento competitivo y crecimiento.",
    "Competitor compare intelligence": "Inteligencia comparativa",
    "Improvement calendar": "Calendario de mejoras",
    "Seller Pro growth graph": "Gráfico de crecimiento Seller Pro",
    "Product score movement": "Movimiento del score",
    "Deeper action planning": "Plan de acción más profundo",
    "Login, security, language, account mode, and privacy-friendly traffic counts use essential storage. Optional Google ad cookies load only if you accept.": "Inicio de sesión, seguridad, idioma, modo de cuenta y conteos de tráfico respetuosos con la privacidad usan almacenamiento esencial. Las cookies opcionales de Google solo cargan si aceptas."
  },
  de: {
    ...
    "Start simple": "Einfach starten",
    "Best for shoppers": "Ideal für Käufer",
    "Seller intelligence": "Seller-Intelligenz",
    "Growth command": "Wachstumssteuerung",
    "For quick product checks before you buy.": "Für schnelle Produktchecks vor dem Kauf.",
    "Trying ReviewIntel without a subscription.": "ReviewIntel ohne Abo testen.",
    "3 product scans per day": "3 Produktscans pro Tag",
    "Screenshot or product-link scan": "Scan per Screenshot oder Produktlink",
    "BUY / REVIEW FIRST / AVOID verdict": "Urteil KAUFEN / PRÜFEN / MEIDEN",
    "Latest result only": "Nur neuestes Ergebnis",
    "For people who compare often and want stronger buying confidence.": "Für Menschen, die oft vergleichen und sicherer kaufen wollen.",
    "Frequent online shopping, deal checks, and product comparison.": "Häufiges Online-Shopping, Deal-Prüfung und Vergleich.",
    ...
    "Seller product health scan": "Seller-Produktscan",
    "Complaint clustering": "Beschwerde-Cluster",
    "Buyer psychology signals": "Käuferpsychologie-Signale",
    "Export-ready insights": "Exportfertige Insights",
    "Seller dashboard history": "Seller-Dashboard-Historie",
    "For serious sellers tracking improvement over time and learning how to outgrow competitors.": "Für ernsthafte Seller, die Verbesserungen verfolgen und Wettbewerber überholen wollen.",
    "Product improvement tracking, competitor positioning, and growth planning.": "Produktverbesserung, Wettbewerbspositionierung und Wachstumsplanung.",
    "Competitor compare intelligence": "Wettbewerbsvergleich",
    "Improvement calendar": "Verbesserungskalender",
    "Seller Pro growth graph": "Seller-Pro-Wachstumsdiagramm",
    "Product score movement": "Score-Entwicklung",
    "Deeper action planning": "Tiefere Aktionsplanung",
    "Login, security, language, account mode, and privacy-friendly traffic counts use essential storage. Optional Google ad cookies load only if you accept.": "Login, Sicherheit, Sprache, Kontomodus und datenschutzfreundliche Traffic-Zählung nutzen notwendigen Speicher. Optionale Google-Werbe-Cookies laden nur nach Zustimmung."
  },
  zh: {
    ...
    "Start simple": "简单开始",
    "Best for shoppers": "最适合买家",
    "Seller intelligence": "卖家智能",
    "Growth command": "增长指挥",
    "For quick product checks before you buy.": "购买前快速检查产品。",
    "Trying ReviewIntel without a subscription.": "无需订阅即可试用 ReviewIntel。",
    "3 product scans per day": "每天 3 次产品扫描",
    "Screenshot or product-link scan": "截图或产品链接扫描",
    "BUY / REVIEW FIRST / AVOID verdict": "买入 / 考虑 / 避免 判断",
    "Latest result only": "仅保留最新结果",
    "For people who compare often and want stronger buying confidence.": "适合经常比较并希望更有购买信心的人。",
    "Frequent online shopping, deal checks, and product comparison.": "频繁网购、优惠检查和产品比较。",
    ...
    "Seller product health scan": "卖家产品健康扫描",
    "Complaint clustering": "投诉聚类",
    "Buyer psychology signals": "买家心理信号",
    "Export-ready insights": "可导出的洞察",
    "Seller dashboard history": "卖家仪表板历史",
    "For serious sellers tracking improvement over time and learning how to outgrow competitors.": "适合跟踪长期改进并希望超越竞争对手的卖家。",
    "Product improvement tracking, competitor positioning, and growth planning.": "产品改进跟踪、竞争定位和增长规划。",
    "Competitor compare intelligence": "竞争对比智能",
    "Improvement calendar": "改进日历",
    "Seller Pro growth graph": "Seller Pro 增长图",
    "Product score movement": "产品分数变化",
    "Deeper action planning": "更深入的行动计划",
    "Login, security, language, account mode, and privacy-friendly traffic counts use essential storage. Optional Google ad cookies load only if you accept.": "登录、安全、语言、账户模式和隐私友好的流量统计使用必要存储。只有接受后，Google 广告 Cookie 才会加载。"
  },
  hi: {
    ...
    "Start simple": "Simple start",
    "Best for shoppers": "Shoppers के लिए best",
    "Seller intelligence": "Seller intelligence",
    "Growth command": "Growth command",
    "For quick product checks before you buy.": "खरीदने से पहले quick product checks के लिए.",
    "Trying ReviewIntel without a subscription.": "Subscription के बिना ReviewIntel try करने के लिए.",
    "3 product scans per day": "हर दिन 3 product scans",
    "Screenshot or product-link scan": "Screenshot या product-link scan",
    "BUY / REVIEW FIRST / AVOID verdict": "BUY / REVIEW FIRST / AVOID verdict",
    "Latest result only": "सिर्फ latest result",
    "For people who compare often and want stronger buying confidence.": "उन लोगों के लिए जो अक्सर compare करते हैं और ज्यादा buying confidence चाहते हैं.",
    "Frequent online shopping, deal checks, and product comparison.": "Frequent online shopping, deal checks और product comparison.",
    ...
    "Seller product health scan": "Seller product health scan",
    "Complaint clustering": "Complaint clustering",
    "Buyer psychology signals": "Buyer psychology signals",
    "Export-ready insights": "Export-ready insights",
    "Seller dashboard history": "Seller dashboard history",
    "For serious sellers tracking improvement over time and learning how to outgrow competitors.": "Serious sellers के लिए जो improvement track करना और competitors से आगे निकलना चाहते हैं.",
    "Product improvement tracking, competitor positioning, and growth planning.": "Product improvement tracking, competitor positioning और growth planning.",
    "Competitor compare intelligence": "Competitor compare intelligence",
    "Improvement calendar": "Improvement calendar",
    "Seller Pro growth graph": "Seller Pro growth graph",
    "Product score movement": "Product score movement",
    "Deeper action planning": "Deeper action planning",
    "Login, security, language, account mode, and privacy-friendly traffic counts use essential storage. Optional Google ad cookies load only if you accept.": "Login, security, language, account mode और privacy-friendly traffic counts essential storage use करते हैं. Optional Google ad cookies सिर्फ accept करने पर load होंगे."
  }
};
...
export function getUiTextTranslations(locale: string | undefined): Record<string, string> {
  ...
  return {
    ...
    ...(releasePricingPhraseTranslations[safeLocale] ?? {})
  };
}
