...
export const seoLandingPages: Record<string, SEOLandingPage> = {
  "consumer-review-analyzer": {
    ...
    description:
      "Paste product reviews and get a fast shopper verdict, fake-review risk, value score, best-for match, and biggest complaint.",
    audience: "Shopper",
  ...
  "amazon-review-analyzer": {
    ...
    description:
      "Analyze pasted Amazon review text or screenshots to understand product quality, fake-risk signals, complaints, and value before buying.",
    audience: "Shopper",
    ...
    highlights: ["Paste Amazon reviews", "Review quality indicators", "Complaint patterns", "Best-for match"]
  },
...
Object.values(seoLandingPages).forEach((page) => {
  page.sections = [
    ...
    },
    {
      title: "How to use it",
      body:
        "Paste reviews, upload TXT or CSV batches, or use screenshot quick scan. ReviewIntel creates the correct Shopper or Seller output based on the active workspace."
    }
  ];
});
