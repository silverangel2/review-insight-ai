  ...
  return (
    ...
    <main className="reviewintel-home-main bg-[linear-gradient(135deg,#a8eee8_0%,#e7fbff_34%,#c7e2ff_66%,#fff0c9_100%)] text-ink">
      ...
      <section className="reviewintel-home-hero relative isolate overflow-hidden border-b border-white/60">
        ...
        <div className="reviewintel-home-hero-grid relative isolate mx-auto grid h-auto min-h-0 max-w-7xl overflow-hidden gap-8 px-5 py-8 sm:min-h-0 sm:overflow-visible sm:px-6 sm:py-8 xl:grid-cols-[0.92fr_1.08fr] xl:items-center">
          ...
          <div className="ri-hero-visual relative mx-auto hidden min-h-[540px] w-full max-w-[680px] overflow-hidden rounded-[2.8rem] border border-white/70 bg-[linear-gradient(135deg,rgba(6,17,35,0.96),rgba(16,72,111,0.78)_42%,rgba(56,148,180,0.48)_68%,rgba(255,255,255,0.28)_100%)] shadow-[0_45px_150px_rgba(12,36,68,0.3)] backdrop-blur-lg sm:block md:min-h-[600px]">
            ...
            <div className="reviewintel-home-card-stage relative z-10 grid min-h-[540px] grid-cols-1 grid-rows-[auto_auto_auto_auto_auto] gap-4 p-5 sm:grid-cols-2 sm:grid-rows-[auto_auto_auto] md:min-h-[600px] md:gap-5 md:p-6">
