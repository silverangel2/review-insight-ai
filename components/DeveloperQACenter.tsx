...
import { clearClientAccount, getClientAccount, getStoredQuota, quotaText, saveActiveMode, saveClientAccount, saveQuota } from "@/lib/clientAccount";
        ...
        <article className="rounded-2xl border border-line bg-white p-5 shadow-soft dark:border-white/10 dark:bg-slate-950">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            ...
            <Link href="/compare" className="rounded-xl border border-line p-4 text-sm font-black text-ink transition hover:border-ocean dark:border-white/10 dark:text-white">
              Test Shopper comparison
            </Link>
            <Link href="/dashboard/seller/compare" className="rounded-xl border border-line p-4 text-sm font-black text-ink transition hover:border-ocean dark:border-white/10 dark:text-white">
              Test Seller Pro comparison
            </Link>
