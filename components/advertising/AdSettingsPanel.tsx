  ...
  return (
    <section className="rounded-3xl border border-line bg-white p-6 shadow-soft dark:border-white/10 dark:bg-white/[0.04]">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-4">
        <ToggleButton
          label="Global ads"
          description="Master switch for every public ad slot."
          value={settings.adsEnabled}
          onChange={(value) => saveSettings({ adsEnabled: value })}
        />

        <ToggleButton
          label="Approved sponsor ads"
          description="Real advertiser campaigns you approved in this admin page."
        ...
        <ToggleButton
          ...
          description="Your own ReviewIntel promo fallback when no paid ad is available."
